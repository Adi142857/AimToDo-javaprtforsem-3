    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builderSingle.setTitle("Select One Name please:-");
      ...
      // I used Custom ArrayAdapter and some help of Tutorial With Example.
        // ArrayAdapter is a type of Adapter which acts a bridge between UI component and data source that helps us to fill data in UI component.
        //So the linking is done in this way.
          ...
          case R.id.update:
              ...
              builder.setPositiveButton("okay", new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(DialogInterface dialog, int which) {
                      ...
                      /*https://samderlust.com/dev-blog/mobile-development.create-a-simple-todo-app-in-basics*/
